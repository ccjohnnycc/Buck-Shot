...
import { View, Text, Image, FlatList, TouchableOpacity, StyleSheet, Dimensions, Alert, Modal, TextInput, ScrollView } from 'react-native';
...
export default function OfflineMapsScreen() {
  ...
  const deleteImage = async (uri: string) => {
    try {
      ...
      try { await FileSystem.deleteAsync(metaPath(uri), { idempotent: true }); } catch {}
      await loadImages();
      setViewerUri(null); 
    } catch (err) {
